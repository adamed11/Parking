...
public class EntryScreen extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parse.initialize(this, "7vihNeuDIU6tOTxHxLxEbp9OIiV3ye7BB6cgS644", "Rbs8OfqHyOVMu3I19KtRubYXVQp3qjoeQuKGIluz");
                ...
                public void onClick(View v) {
                    if (etMail.getVisibility() == View.INVISIBLE) {
                        ...
                        if(!etUsermame.getText().toString().isEmpty() && !etPassword.getText().toString().isEmpty()) {
                            user.setUsername(etUsermame.getText().toString());
    ...
    private void checkUserDetails(final PsUser user, final String action) {
        ...
        model.checkUser(new Model.checkUserCallback() {
            @Override
            ...
            public void result(boolean userResult) {
                ...
                if ((userResult && action.equals("SignUp")) || (!userResult && action.equals("LogIn"))) {
                    ...
                    if(action.equals("SignUp")){
                        ...
                        model.addUser(new Model.addUserClbk() {
                            @Override
